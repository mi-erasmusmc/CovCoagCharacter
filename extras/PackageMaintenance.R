...
OhdsiRTools::checkUsagePackage("CovCoagCharacter")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/CovCoagCharacter.pdf")
shell("R CMD Rd2pdf ./ --output=extras/CovCoagCharacter.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("CovCoagCharacter")
