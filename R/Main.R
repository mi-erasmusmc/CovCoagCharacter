...
#
# This file is part of CovCoagCharacter
#
...
#'
#' @details
#' This function executes the CovCoagCharacter Study.
#' 
...
execute <- function(connectionDetails,
  ...
  if(runAnalyses || onlyFetchData){
    ...
    result <- do.call(runCharAnalyses, predictionAnalysisList)
  }
  ...
  if(createValidationPackage){
    ...
    if(!saveModelsToJson){
      ...
      tryCatch({
        ...
        createValidationPackageJson(devPackageName = 'CovCoagCharacter',
                                    devDatabaseName = cdmDatabaseName,
                                    analysisLocation = outputFolder,
                                    analysisIds = analysesToValidate,
                                    outputFolder = outputFolder,
                                    packageName = 'CovCoagCharacterValidation',
                                    description = 'validating models in CovCoagCharacter',
                                    skeletonVersion = skeletonVersion,
                                    createdBy = 'anonymous',
